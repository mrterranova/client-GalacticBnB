...
export class MoreFiltersComponent implements OnInit {
  public moreFiltersSections = {
    ...
    neighborhoods: {
      name: 'Neighborhoods',
      filters: new Map<string, boolean>()
        .set('Nearby Area 01', false)
        .set('Nearby Area 02', false)
        .set('Nearby Area 03', false)
        .set('Nearby Area 04', false)
        .set('Nearby Area 05', false)
        .set('Nearby Area 06', false)
        .set('Nearby Area 07', false)
        .set('Nearby Area 08', false)
        .set('Nearby Area 09', false)
